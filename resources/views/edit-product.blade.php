    ...
    <div>
        <form method="POST" action="{{ route('product.update', ['product' => $product->id]) }}" class="form" enctype="multipart/form-data">
            ...
            <div class="form-content">
                ...
                <input type="text" name="name" id="name" class="form-control" value="{{ $product->name }}" placeholder="Enter Name" required>
            </div>
            <div class="form-content">
                <label for="price" class="form-label">Price</label>
                <input type="number" name="price" id="price" class="form-control" value="{{ $product->price }}" placeholder="Enter Price" required>
            </div>
            <div class="form-content">
